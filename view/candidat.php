                    ...
                    <tbody>
                        ...
                        ?>
                            <tr class="freelancer">
                                ...
                                <td>
                                    <a type=" button" class="btn btn-success" href="?route=acceptcandidat&id=<?= $row['idoffre']; ?>"">
                                    accept
                                </a>
                                     <a type=" button" class=" btn btn-danger" href="?route=refusecandidat&id=<?= $row['idoffre']; ?>">
                                        refuse
                                    </a>
                                </td>
                            </tr>
