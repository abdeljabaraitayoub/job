                            ...
                            <div class="card-body  p-4">
                                <div class="d-flex justify-content-between px-md-1">
                                    <div>
                                        ...
                                        <div class="mt-4">
                                            <h3><strong><?= $job1->countTotalJobOffers() ?></strong></h3>
                            ...
                            <div class="card-body p-4">
                                <div class="d-flex justify-content-between px-md-1">
                                    <div>
                                        ...
                                        <div class="mt-4">
                                            <h3><strong><?= $job1->countActiveJobOffers() ?></strong></h3>
                    ...
                    <div class="col-xl-3 col-sm-6 col-12 mb-4">
                        <div class="card">
                            <div class="card-body p-4">
                                <div class="d-flex justify-content-between px-md-1">
                                    <div>
                                        <p class="mb-0">Nombre total des offres Inactif</p>
                                        <div class="mt-4">
                                            <h3><strong><?= $job1->countInactiveJobOffers() ?></strong></h3>
                            ...
                            <div class="card-body p-4">
                                <div class="d-flex justify-content-between px-md-1">
                                    <div>
                                        ...
                                        <div class="mt-4">
                                            <h3><strong><?= $job1->countApprovedJobOffers() ?></strong></h3>
                                        </div>
                                    </div>
                                    <div class="">
